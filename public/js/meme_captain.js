var MEMECAPTAIN = (function () {
    ...
    my.config.genDataType = my.config.genUrl === '/g' ? 'json' : 'jsonp';
...
function createImage() {
    ...
    }, MEMECAPTAIN.config.genDataType).error(function (j) {
